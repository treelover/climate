...
WriteXLS(x = 'laumasta',ExcelFileName = paste(vdir,'Lau_master_climveg_6mo_6lag.xls',sep=''),AdjWidth = T)
...
#write it out for its own self
WriteXLS(x = 'palmasta',ExcelFileName = paste(vdir,'Pal_master_climveg_6mo_6lag.xls',sep=''),AdjWidth = T)
...
#write it out for its own self
WriteXLS(x = 'mamamasta',ExcelFileName = paste(vdir,'Mam_master_climveg_6mo_6lag.xls',sep=''),AdjWidth = T)

#Fix the masta survey_2014 column 
masta$survey_2014 = as.POSIXlt(masta$survey_2014)	

masta = rbind(masta,mamamasta)
WriteXLS(x = 'masta',ExcelFileName = paste('/home/adam/Dropbox/sapflow/veg/master_climveg_6mo_6lag.xls',sep=''),AdjWidth = T)
#============================================================#
#------------------------------------------------------------#
#............................................................#
#------------------------------------------------------------#
