...
#---------------------------------------#
clim1 = climread('/home/adam/Dropbox/sapflow/veg/mam/Mamalahoa_20140414.dat')
clim2 = climread('/home/adam/Dropbox/sapflow/veg/mam/Mamalahoa_20140501.dat')
clim3 = climread('/home/adam/Dropbox/sapflow/veg/mam/Mamalahoa_20140618.dat')
clim4 = climread('/home/adam/Dropbox/sapflow/clim/Mamalahoa_MetData.dat')
...
colnames(newclim) = colnames(mama)[1:18]

#Cranking through the clear sky stuff
#---------------------------------------------------------#
rdir = '/home/adam/Dropbox/sapflow/clim/clear_sky_rad/raw/'
rest = read_REST2(paste(rdir,'Mamalahoa_REST2_out.txt',sep=''))
...
final = rbind(mama,stat)

save(final,file = '/home/adam/Dropbox/sapflow/veg/mam/mam_climdata.Rdat')
