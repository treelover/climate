...
#WIND SPEED WEEE!
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
png(filename = paste(figdir,now,'_',statnames[i],'_Wind.png',sep=''),width = 600, height = 600)
...
#Soil Heat Flux
jpeg(filename = paste(figdir,now,'_Laupahoehoe_SHeat.jpeg',sep=''),width = 1000, height = 600)
	
	#Title
	title = paste('Soil Heat Flux at Laupahoehoe ',strftime(threeback,format = '%B %d'),' through ',strftime(dayback,format = '%B %d, %Y'),sep='')
...
#Soil Temperature
jpeg(filename = paste(figdir,now,'_Laupahoehoe_ST.jpeg',sep=''),width = 1000, height = 600)
	
	#Title
	title = paste('Soil Temperature at Laupahoehoe ',strftime(threeback,format = '%B %d'),' through ',strftime(dayback,format = '%B %d, %Y'),sep='')
...
#Soil Moisture
jpeg(filename = paste(figdir,now,'_PuuWaawaa_SM.jpeg',sep=''),width = 1000, height = 600)
	
	#Title
	title = paste('Soil Moisture at Puu Waawaa ',strftime(threeback,format = '%B %d'),' through ',strftime(dayback,format = '%B %d, %Y'),sep='')
...
#Soil Heat Flux
jpeg(filename = paste(figdir,now,'_PuuWaawaa_SHeat.jpeg',sep=''),width = 1000, height = 600)
	
	#Title
	title = paste('Soil Heat Flux at Puu Waawaa ',strftime(threeback,format = '%B %d'),' through ',strftime(dayback,format = '%B %d, %Y'),sep='')
...
#Soil Temperature
jpeg(filename = paste(figdir,now,'_PuuWaawaa_ST.jpeg',sep=''),width = 1000, height = 600)
	
	#Title
	title = paste('Soil Temperature at Puu Waawaa ',strftime(threeback,format = '%B %d'),' through ',strftime(dayback,format = '%B %d, %Y'),sep='')
