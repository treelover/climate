mamalahoa_plot = function(dlist,now,dayback,threeback){
...
mtext('Mamalahoa',cex = 4, font = 2, outer = F,line = -10)
	...
	if(length(dlist$time) < (6*24*3)){
		...
		text(x = c(5,5), y = c(5,4), labels = c('Mamalahoa','Less than 3 days of data. Check data file!'))
		stop()
	}
	#...............................................#
	...
	if(length(which(dlist$time == threeback)) == 0 | length(which(dlist$time == now)) == 0){
		par(mfrow = c(1,1),mar = c(0,5,5,4),oma=c(3,0,0,0))
		plot(x = 1:10,y = 1:10, type = 'n')
		text(x = c(5,5), y = c(5,4), labels = c('Mamalahoa','Last 3 days of data not found. Check data file!'))
		stop()
	}
	#...............................................#
