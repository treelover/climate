spencer_plot = function(dlist,now,dayback,threeback){
...
#Spencer climate station. As of Oct 15th, 2014, the following instruments are installed and will be plotted:
# HMP45C (2)
#   - Air Temperature
#   - Relative Humidity
# NR01
...
mtext('Spencer',cex = 4, font = 2, outer = F,line = -10)
	...
	if(length(dlist$time) < (6*24*3)){
		...
		text(x = c(5,5), y = c(5,4), labels = c('Spencer','Less than 3 days of data. Check data file!'))
		stop()
	}
	#...............................................#
	...
	if(length(which(dlist$time == threeback)) == 0 | length(which(dlist$time == now)) == 0){
		par(mfrow = c(1,1),mar = c(0,5,5,4),oma=c(3,0,0,0))
		plot(x = 1:10,y = 1:10, type = 'n')
		text(x = c(5,5), y = c(5,4), labels = c('Spencer','Last 3 days of data not found. Check data file!'))
		stop()
	}
	#...............................................#
...
R2 = rdat[which(dlist$time == threeback):which(dlist$time == now),'SoilHeatFlux_2_Avg']
	...
	if(all(is.na(R1)) | all(is.na(R2))){
		plot(x = 1:10,y = 1:10, type = 'n',xlab = '',ylab='')
		text(x = c(5,5), y = c(5,4), labels = c('Soil Heat Flux 1 or 2 all NA.', 'Check data file!'))
	}else{
	#...............................................#
...
legend('topleft',fill = cols,legend = paste('SHF',1:2),bg='white')
	}
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
...
#Soil moisture data
R1 = rdat[which(dlist$time == threeback):which(dlist$time == now),'Tsoil_Avg']

	#Eigth test: if the last 3 days are all NA
	#...............................................#
	if(all(is.na(R1))){
		plot(x = 1:10,y = 1:10, type = 'n',xlab = '',ylab='')
		text(x = c(5,5), y = c(5,4), labels = c('Soil Temperature all NA.', 'Check data file!'))
	}else{
	#...............................................#
...
legend('topleft',fill = 'red',legend = 'Soil T',bg='white')
	}
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
#=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+#
