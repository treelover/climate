...
source(paste('/home/',home,'/Dropbox/sapflow/r_scripts/fun/climwrite.r',sep=''))
#---------------------------------------#
...
czipdir = paste('/home/',home,'/Dropbox/sapflow/climzip/',sep='')
tempdir = paste('/home/',home,'/Dropbox/sapflow/climzip/temp/',sep='')
dropdir = paste('/home/',home,'/Dropbox/Big\ Island\ PI\ Access/Recent\ Station\ Downloads/',sep='')
dropdirwin = paste('/home/',home,'/Dropbox/Big\\ Island\\ PI\\ Access/Recent\\ Station\\ Downloads/',sep='')
#---------------------------------------#
